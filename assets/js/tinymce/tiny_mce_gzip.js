var tinyMCE_GZ = {
	...
	loadScripts : function(co, th, pl, la, cb, sc) {
		...
		/** TangoCMS Custom Implementation */
		q = 'core/' + (co ? 'true' : 'false') + '/themes/' + escape(th) + '/plugins/' + escape(pl) + '/language/' + escape(la);	
...
//		x.setRequestHeader('Content-Type', 'text/javascript');
		/** TangoCMS Custom Implementation */
		x.open( 'GET', zula_dir_base + 'index.php?url=/editor/compressor/index/' + q, !!cb );
